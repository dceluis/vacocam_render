...
def cluster_detections(detections_list: List[Detections], image_height=1, image_width=1, preset=None):
    ...
    spatial_clustering_distance_factor = 1.1
    temporal_clustering_distance_factor = 1.3
    ...
    X_Y_scaled = X_Y * spatial_clustering_distance_factor
    W_H_scaled = W_H * spatial_clustering_distance_factor
    FRAME_scaled = MinMaxScaler().fit_transform(FRAME.reshape(-1, 1)) * temporal_clustering_distance_factor
